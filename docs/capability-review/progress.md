...
5. **Counts of the shared suite live here and nowhere else.** All eight
   ...
   register's last update the suite is **104 `.tsv` files, 102
   row-bearing, 4,378 rows**, in twenty-five modes — `canon` 868,
   `errc` 770, `gens` 697, `gen` 590, `err` 279, `view` 174, `fmt` 154,
   `errcode` 141, `subsume` 114, `vet` 100, `query` 92, `jsonschema`
   ...
   dispatch; before that, 2026-09-03 for the 0.56.0 release, where
