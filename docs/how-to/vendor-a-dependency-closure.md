...
{"lock":{"corp.example/schemas/service@1":{"canon":"aon1-oQs6Ng6XxP2FHQGTYescREGDrDPfLLW1Liq4OS8Gs2E","oci":"","v":"1.4.2"}}}
```
...
one, and the repair those lines name is honest about what does not
ship:
