...
export declare function engineFinding(nil: any, ctx: any, path: string): VetFinding;
...
export declare function vetCoverage(anchor: any, dataVal: any, coverageAt?: string, root?: any): VetCoverage;
