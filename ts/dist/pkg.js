...
exports.LOCK_HEADER = '# pkg-lock.aontu (generated by `aontu sync`; do not edit)\n';
...
exports.ARCHIVE_SOURCE_EXT = ['aontu'];
...
function storedManifest(dir) {
    const file = (0, node_path_1.join)(dir, mod_1.META_DIR, 'manifest.aontu');
    if (!(0, node_fs_1.existsSync)(file)) {
        return undefined;
    }
