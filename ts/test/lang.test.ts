...
describe('lang', function() {
  ...
  it('file', () => {
    ...
    let t00x = g0.parse('x:@"' + srcPath(__dirname) + '/../test/t00.aontu"')
    expect(t00x.canon).equal('{"x":{"a":1}}')

    let t00xA = g0.parse('A:11,x:@"' + srcPath(__dirname) + '/../test/t00.aontu"')
    expect(t00xA.canon).equal('{"A":11,"x":{"a":1}}')
    let t00xB = g0.parse('x:@"' + srcPath(__dirname) + '/../test/t00.aontu",B:22')
    expect(t00xB.canon).equal('{"B":22,"x":{"a":1}}')
    let t00xAB = g0.parse('A:11,x:@"' + srcPath(__dirname) + '/../test/t00.aontu",B:22')
    expect(t00xAB.canon).equal('{"A":11,"B":22,"x":{"a":1}}')

    let t00xAs = g0.parse('A:11 x:@"' + srcPath(__dirname) + '/../test/t00.aontu"')
    expect(t00xAs.canon).equal('{"A":11,"x":{"a":1}}')
    let t00xBs = g0.parse('x:@"' + srcPath(__dirname) + '/../test/t00.aontu" B:22')
    expect(t00xBs.canon).equal('{"B":22,"x":{"a":1}}')
    let t00xABs = g0.parse('A:11 x:@"' + srcPath(__dirname) + '/../test/t00.aontu" B:22')
    expect(t00xABs.canon).equal('{"A":11,"B":22,"x":{"a":1}}')


    let t00v = g0.parse('@"' + srcPath(__dirname) + '/../test/t00.aontu"')
    expect(t00v.canon).equal('{"a":1}')
    let t00 = new Unify(t00v)
    expect(t00.res.canon).equal('{"a":1}')
    expect(t00.res.gen(ctx)).equal({ a: 1 })

    let t00vX = g0.parse(' X:11 @"' + srcPath(__dirname) + '/../test/t00.aontu"')
    ...
    let t00vY = g0.parse('@"' + srcPath(__dirname) + '/../test/t00.aontu" Y:22 ')
    ...
    let t00dv = g0.parse('D:{@"' + srcPath(__dirname) + '/../test/t00.aontu"}')
    ...
    let t02v = g0.parse('@"' + srcPath(__dirname) + '/../test/t02.aontu"')
    expect(t02v.canon).equal('{"x":1,"y":2}')


    let t00m = g0.parse(`
    @"` + srcPath(__dirname) + `/../test/t00.aontu"
    `)
    expect(t00m.canon).equal('{"a":1}')

    let t01m = g0.parse(`
    @"` + srcPath(__dirname) + `/../test/t00.aontu"
    @"` + srcPath(__dirname) + `/../test/t04.aontu"
    `)
