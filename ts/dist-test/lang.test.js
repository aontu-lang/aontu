...
(0, node_test_1.describe)('lang', function () {
    ...
    (0, node_test_1.it)('file', () => {
        ...
        let t00x = g0.parse('x:@"' + (0, srcpath_1.srcPath)(__dirname) + '/../test/t00.aontu"');
        (0, expect_1.expect)(t00x.canon).equal('{"x":{"a":1}}');
        let t00xA = g0.parse('A:11,x:@"' + (0, srcpath_1.srcPath)(__dirname) + '/../test/t00.aontu"');
        (0, expect_1.expect)(t00xA.canon).equal('{"A":11,"x":{"a":1}}');
        let t00xB = g0.parse('x:@"' + (0, srcpath_1.srcPath)(__dirname) + '/../test/t00.aontu",B:22');
        (0, expect_1.expect)(t00xB.canon).equal('{"B":22,"x":{"a":1}}');
        let t00xAB = g0.parse('A:11,x:@"' + (0, srcpath_1.srcPath)(__dirname) + '/../test/t00.aontu",B:22');
        (0, expect_1.expect)(t00xAB.canon).equal('{"A":11,"B":22,"x":{"a":1}}');
        let t00xAs = g0.parse('A:11 x:@"' + (0, srcpath_1.srcPath)(__dirname) + '/../test/t00.aontu"');
        (0, expect_1.expect)(t00xAs.canon).equal('{"A":11,"x":{"a":1}}');
        let t00xBs = g0.parse('x:@"' + (0, srcpath_1.srcPath)(__dirname) + '/../test/t00.aontu" B:22');
        (0, expect_1.expect)(t00xBs.canon).equal('{"B":22,"x":{"a":1}}');
        let t00xABs = g0.parse('A:11 x:@"' + (0, srcpath_1.srcPath)(__dirname) + '/../test/t00.aontu" B:22');
        (0, expect_1.expect)(t00xABs.canon).equal('{"A":11,"B":22,"x":{"a":1}}');
        let t00v = g0.parse('@"' + (0, srcpath_1.srcPath)(__dirname) + '/../test/t00.aontu"');
        ...
        let t00vX = g0.parse(' X:11 @"' + (0, srcpath_1.srcPath)(__dirname) + '/../test/t00.aontu"');
        ...
        let t00vY = g0.parse('@"' + (0, srcpath_1.srcPath)(__dirname) + '/../test/t00.aontu" Y:22 ');
        ...
        let t00dv = g0.parse('D:{@"' + (0, srcpath_1.srcPath)(__dirname) + '/../test/t00.aontu"}');
        ...
        let t02v = g0.parse('@"' + (0, srcpath_1.srcPath)(__dirname) + '/../test/t02.aontu"');
        (0, expect_1.expect)(t02v.canon).equal('{"x":1,"y":2}');
        let t00m = g0.parse(`
    @"` + (0, srcpath_1.srcPath)(__dirname) + `/../test/t00.aontu"
    `);
        (0, expect_1.expect)(t00m.canon).equal('{"a":1}');
        let t01m = g0.parse(`
    @"` + (0, srcpath_1.srcPath)(__dirname) + `/../test/t00.aontu"
    @"` + (0, srcpath_1.srcPath)(__dirname) + `/../test/t04.aontu"
    `);
