...
Generated by [`../tools/diagram.js`](../tools/diagram.js) from `subsume`
alone, and pinned as a golden by `check.sh`. An edge means the upper
document **admits everything** the lower one does.
...
33. The subsumption poset above renders from the seven documents and
    matches `expected/diagram-poset.mmd`.
