...
One caveat while [BUGS 64](../BUGS.md) stands: a document whose schema
is shared by reference or alias does not currently subsume *itself*, so
some models produce a poset with fewer edges than their semantics
warrant.
